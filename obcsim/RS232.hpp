/*
 * RS_init
 * Initializes the RS232 communication by opening the Serial2 port
 */

void RS_init(void);

/* RS_read 
 *  Gets called when signaled that there is data on the Serial2 line
...
/* RS_send
 *  Sends the data from the OBC over the serial2 line to the RS232.
